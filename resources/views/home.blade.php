    ...
    <section class="container mx-auto px-6 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
            ...
            <div class="col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8">
                <img src="storage/images/trendingImage1.png" alt="Image 1"
                    class="w-full h-32 md:h-40 lg:h-64 object-cover rounded">
                <img src="storage/images/trendingImage2.png" alt="Image 2"
                    class="w-full h-32 md:h-40 lg:h-64 object-cover rounded">
                <img src="storage/images/trendingImage3.png" alt="Image 3"
                    class="w-full h-32 md:h-40 lg:h-64 object-cover rounded">
                <img src="storage/images/trendingImage4.png" alt="Image 4"
                    class="w-full h-32 md:h-40 lg:h-64 object-cover rounded">
            </div>
        </div>
    </section>
